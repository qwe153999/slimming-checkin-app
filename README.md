...
2. Make sure you have Android SDK for API 34 and Gradle installed.
3. Sync Gradle and run the `app` module on a device or emulator.

Notes
- This is a minimal demo. You can extend the UI, validation, and add export/sync features.
